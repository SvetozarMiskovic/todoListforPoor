...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addTask\": () => (/* binding */ addTask)\n/* harmony export */ });\n/* harmony import */ var _renderElFunctions_createTaskItem__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./renderElFunctions/createTaskItem */ \"./src/renderElFunctions/createTaskItem.js\");\n/* harmony import */ var _renderElFunctions_createDeleteTaskButton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderElFunctions/createDeleteTaskButton */ \"./src/renderElFunctions/createDeleteTaskButton.js\");\n\r\n\r\n\r\nfunction addTask(createID, text) {\r\n  // Create a task\r\n  const task = (0,_renderElFunctions_createTaskItem__WEBPACK_IMPORTED_MODULE_0__.createTaskItem)(createID);\r\n  // Create the remove button\r\n  const span = (0,_renderElFunctions_createDeleteTaskButton__WEBPACK_IMPORTED_MODULE_1__.createDeleteTaskButton)(createID);\r\n\r\n  // Add to DOM\r\n  task.textContent = text;\r\n  task.appendChild(span);\r\n\r\n  if (text) return task;\r\n}\r\n\n\n//# sourceURL=webpack://rstate/./src/addTask.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"taskSection\": () => (/* binding */ taskSection),\n/* harmony export */   \"selectList\": () => (/* binding */ selectList),\n/* harmony export */   \"selectSort\": () => (/* binding */ selectSort)\n/* harmony export */ });\n/* harmony import */ var _firebase_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../firebase.json */ \"./firebase.json\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _getElsAndAppend__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getElsAndAppend */ \"./src/getElsAndAppend.js\");\n/* harmony import */ var _saveLS__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./saveLS */ \"./src/saveLS.js\");\n/* harmony import */ var _getLS__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./getLS */ \"./src/getLS.js\");\n/* harmony import */ var _renderElFunctions_createList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./renderElFunctions/createList */ \"./src/renderElFunctions/createList.js\");\n/* harmony import */ var _recordEditID__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./recordEditID */ \"./src/recordEditID.js\");\n/* harmony import */ var _sortByNewest__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sortByNewest */ \"./src/sortByNewest.js\");\n/* harmony import */ var _sortByOldest__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./sortByOldest */ \"./src/sortByOldest.js\");\n/* harmony import */ var _refreshDOM__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./refreshDOM */ \"./src/refreshDOM.js\");\n/* harmony import */ var _compareAsc__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./compareAsc */ \"./src/compareAsc.js\");\n/* harmony import */ var _compareDesc__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./compareDesc */ \"./src/compareDesc.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst taskSection = document.querySelector('.task-section');\r\nconst selectList = document.getElementById('select-list');\r\nconst selectSort = document.getElementById('sort');\r\n\r\nconst submitBtn = document.getElementById('submitBtn');\r\nconst createListBtn = document.querySelector('.newListBtn');\r\n\r\nconst input = document.querySelector('#todoTask');\r\ndocument.addEventListener('DOMContentLoaded', _getLS__WEBPACK_IMPORTED_MODULE_4__.getLS);\r\nconst db = getFirestore(_firebase_json__WEBPACK_IMPORTED_MODULE_0__.firestore);\r\nconsole.log(db);\r\nsubmitBtn.onclick = function (e) {\r\n  e.preventDefault();\r\n  const elNum = document.querySelectorAll('.task-container').length;\r\n  const sortValue = selectSort.value;\r\n  let createID = dayjs().valueOf();\r\n\r\n  if (elNum > 0) {\r\n    const selectedValue = selectList.value;\r\n\r\n    const element = (0,_getElsAndAppend__WEBPACK_IMPORTED_MODULE_2__.getElsAndAppend)(selectedValue, createID, input.value);\r\n    const editEl = (0,_recordEditID__WEBPACK_IMPORTED_MODULE_6__.recordEditID)(element);\r\n    if (sortValue === 'Newest updates') {\r\n      (0,_sortByNewest__WEBPACK_IMPORTED_MODULE_7__.sortByNewest)(editEl);\r\n    } else if (sortValue === 'Oldest updates') {\r\n      (0,_sortByOldest__WEBPACK_IMPORTED_MODULE_8__.sortByOldest)(editEl);\r\n    }\r\n    (0,_saveLS__WEBPACK_IMPORTED_MODULE_3__.saveLS)();\r\n  } else {\r\n    if (input.value) {\r\n      const listPrompt = prompt('Please name your list!', 'New List');\r\n      if (!listPrompt) {\r\n        input.value = '';\r\n        return;\r\n      } else {\r\n        const element = (0,_renderElFunctions_createList__WEBPACK_IMPORTED_MODULE_5__.createList)(createID, listPrompt);\r\n        (0,_getElsAndAppend__WEBPACK_IMPORTED_MODULE_2__.getElsAndAppend)(createID, createID + 1, input.value);\r\n        const editEl = (0,_recordEditID__WEBPACK_IMPORTED_MODULE_6__.recordEditID)(element);\r\n        if (sortValue === 'Newest updates') {\r\n          (0,_sortByNewest__WEBPACK_IMPORTED_MODULE_7__.sortByNewest)(editEl);\r\n        } else if (sortValue === 'Oldest updates') {\r\n          (0,_sortByOldest__WEBPACK_IMPORTED_MODULE_8__.sortByOldest)(editEl);\r\n        }\r\n        (0,_saveLS__WEBPACK_IMPORTED_MODULE_3__.saveLS)();\r\n      }\r\n    }\r\n  }\r\n  input.value = '';\r\n};\r\n\r\ncreateListBtn.onclick = function () {\r\n  let createID = dayjs().valueOf();\r\n\r\n  const listPrompt = prompt('Please name your list!', 'New List');\r\n  if (!listPrompt) {\r\n    input.value = '';\r\n    return;\r\n  } else {\r\n    const element = (0,_renderElFunctions_createList__WEBPACK_IMPORTED_MODULE_5__.createList)(createID, listPrompt);\r\n\r\n    if (selectSort.value === 'Newest updates') {\r\n      taskSection.prepend(element);\r\n    } else {\r\n      taskSection.append(element);\r\n    }\r\n    (0,_saveLS__WEBPACK_IMPORTED_MODULE_3__.saveLS)();\r\n    (0,_refreshDOM__WEBPACK_IMPORTED_MODULE_9__.refreshDOM)();\r\n  }\r\n};\r\n\r\nselectSort.onchange = function (e) {\r\n  const lists = document.querySelectorAll('.task-container');\r\n  const liste = [...lists];\r\n  const selected = e.target.value;\r\n\r\n  const sorted = liste.sort(\r\n    selected === 'Newest updates' ? _compareAsc__WEBPACK_IMPORTED_MODULE_10__.compareAsc : _compareDesc__WEBPACK_IMPORTED_MODULE_11__.compareDesc\r\n  );\r\n  (0,_refreshDOM__WEBPACK_IMPORTED_MODULE_9__.refreshDOM)(sorted);\r\n  // if (selectSort.value === 'Newest updates') {\r\n  //   const sorted = liste.sort(compareAsc);\r\n  //   refreshDOM(sorted);\r\n  // } else {\r\n  //   const sorted = liste.sort(compareDesc);\r\n  //   refreshDOM(sorted);\r\n  // }\r\n};\r\n\n\n//# sourceURL=webpack://rstate/./src/app.js?");
...
eval("module.exports = JSON.parse('{\"hosting\":{\"public\":\"./\",\"ignore\":[\"firebase.json\",\"**/.*\",\"**/node_modules/**\"]},\"firestore\":{\"rules\":\"firestore.rules\",\"indexes\":\"firestore.indexes.json\"}}');\n\n//# sourceURL=webpack://rstate/./firebase.json?");
